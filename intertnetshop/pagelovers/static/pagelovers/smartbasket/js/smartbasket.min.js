document.addEventListener("DOMContentLoaded", function () {
  ...
  s.scope = {}, s.findInternal = function (t, a, e) {
    ...
    return {i: -1, v: void 0};
  }, s.ASSUME_ES5 = false, s.ASSUME_NO_NATIVE_MAP = false, s.ASSUME_NO_NATIVE_SET = false, s.SIMPLE_FROUND_POLYFILL = false, s.defineProperty = s.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function (t, a, e) {
    ...
    if (a) {
      ...
      (a = a(r = e[t = t[t.length - 1]])) != r && null != a && s.defineProperty(e, t, {configurable: true, writable: true, value: a});
    }
    ...
    var a = function (a, e, s) {
      var r = {invalid: [], getCaret: function () {
        try {
        ...
        try {
          if (a.is(":focus")) {
            ...
            if (e.setSelectionRange) e.setSelectionRange(t, t); else {
              ...
              s.collapse(true), s.moveEnd("character", t), s.moveStart("character", t), s.select();
            }
          }
        } catch (t) {}
      }, events: function () {
        a.on("keydown.mask", function (t) {
          ...
          o === r.val() || a.data("changed") || a.trigger("change"), a.data("changed", false);
        }).on("blur.mask", function () {
          o = r.val();
        }).on("focus.mask", function (a) {
          true === s.selectOnFocus && t(a.target).select();
        }).on("focusout.mask", function () {
          s.clearIfNotMatch && !n.test(r.val()) && r.val("");
        });
      }, getRegexMask: function () {
        for (var t, a, s, r, n = [], o = 0; o < e.length; o++) (t = i.translation[e.charAt(o)]) ? (a = t.pattern.toString().replace(/.{1}$|^.{1}/g, ""), s = t.optional, (t = t.recursive) ? (n.push(e.charAt(o)), r = {digit: e.charAt(o), pattern: a}) : n.push(s || t ? a + "?" : a)) : n.push(e.charAt(o).replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
        ...
        var n, o = [], l = void 0 === a ? r.val() : a + "", c = 0, p = e.length, d = 0, u = l.length, m = 1, k = "push", b = -1, f = 0;
        if (a = [], s.reverse) {
          k = "unshift", m = -1;
          var v = 0;
          c = p - 1, d = u - 1;
        ...
        c("onChange", true === i, l), c("onKeyPress", true === i, l), c("onComplete", n.length === e.length, l), c("onInvalid", 0 < r.invalid.length, [n, t, a, r.invalid, s]);
      }};
      a = t(a);
      ...
      e = "function" == typeof e ? e(r.val(), void 0, a, s) : e, i.mask = e, i.options = s, i.remove = function () {
        ...
        return r.getMasked(true);
      }, i.getMaskedVal = function (t) {
        return r.getMasked(false, t);
      }, i.init = function (o) {
        if (o = o || false, s = s || {}, i.clearIfNotMatch = t.jMaskGlobals.clearIfNotMatch, i.byPassKeys = t.jMaskGlobals.byPassKeys, i.translation = t.extend({}, t.jMaskGlobals.translation, s.translation), i = t.extend(true, {}, i, s), n = r.getRegexMask(), o) r.events(), r.val(r.getMasked()); else {
          s.placeholder && a.attr("placeholder", s.placeholder), a.data("mask") && a.attr("autocomplete", "off"), o = 0;
          for (var l = true; o < e.length; o++) {
          ...
          l && a.attr("maxlength", e.length).data("mask-maxlength", true), r.destroyEvents(), r.events(), o = r.getCaret(), r.val(r.getMasked()), r.setCaret(o);
        }
      }, i.init(!a.is("input"));
    };
    t.maskWatchers = {};
    var e = function () {
      ...
      if (e.attr("data-mask-reverse") && (r.reverse = true), e.attr("data-mask-clearifnotmatch") && (r.clearIfNotMatch = true), "true" === e.attr("data-mask-selectonfocus") && (r.selectOnFocus = true), s(e, n, r)) return e.data("mask", new a(this, n, r));
    }, s = function (a, e, s) {
      s = s || {};
    ...
    }, r = {maskElements: "input,td,span,div", dataMaskAttr: "*[data-mask]", dataMask: true, watchInterval: 300, watchInputs: true, keyStrokeCompensation: 10, useInput: !/Chrome\/[2-4][0-9]|SamsungBrowser/.test(window.navigator.userAgent) && r("input"), watchDataMask: false, byPassKeys: [9, 16, 17, 18, 36, 37, 38, 39, 40, 91], translation: {0: {pattern: /\d/}, 9: {pattern: /\d/, optional: true}, "#": {pattern: /\d/, recursive: true}, A: {pattern: /[a-zA-Z0-9]/}, S: {pattern: /[a-zA-Z]/}}}, t.jMaskGlobals = t.jMaskGlobals || {}, (r = t.jMaskGlobals = t.extend(true, {}, r, t.jMaskGlobals)).dataMask && t.applyDataMask(), setInterval(function () {
  ...
  var t, a, e;
  t = jQuery, a = {productElement: "product__element", buttonAddToBasket: "product__add-to-cart-button", countryCode: "+38", smartBasketCurrency: "₴", productQuantityWrapper: false, productPrice: false, productSize: false, smartBasketMinArea: "header__basket-min", smartBasketMinIconPath: "/smartbasket/img/shopping-basket-wight.svg", smartBasketMinText: false, telIsRequired: true, emailIsRequired: false, nameIsRequired: true, localStorageName: "basketItems", yaCounter: {counterID: "", targetID: ""}}, e = {getProducts: function () {
    return JSON.parse(localStorage.getItem(a.localStorageName));
  }, setProducts: function (t) {
    let e = JSON.stringify(t, "", 4);
    return localStorage.setItem(a.localStorageName, e), false;
    ...
    let r = t("<form>").attr({class: "smart-basket__form", method: "POST", id: "smart-basket__form", enctype: "multipart/form-data"}), n = t("<div>").attr({class: "smart-basket__product-item"}), i = t("<div>").attr({class: "smart-basket__product-id"}).text("ID"), o = t("<div>").attr({class: "smart-basket__product-name"}).text("Товар"), l = t("<div>").attr({class: "smart-basket__product-quantity smart-basket__product-quantity_header"}).text("Кол-во"), c = t("<span>").attr({class: "smart-basket__info-icon"}).text("?"), p = t("<button>").attr({class: "smart-basket__info-msgs-close"}).text("×"), d = t("<span>").attr({class: "smart-basket__info-msgs"}).html("Цена за 1 товар или услугу").append(p), u = t("<div>").attr({class: "smart-basket__product-price"}).html(`Цена / ${a.smartBasketCurrency}`).append(c).append(d);
    c.click(() => {
      d.fadeToggle();
    }), p.click(t => {
      t.preventDefault(), d.fadeToggle();
    });
    let m = t("<div>").attr({class: "smart-basket__product-price-common"}).html(`Общая цена / ${a.smartBasketCurrency}`), k = t("<div>").attr({class: "smart-basket__product-delete"}).text("Удалить");
    n.append(o).append(i).append(u).append(l).append(m).append(k), r.append(n);
    for (let n in s) {
      let i = t("<div>").attr({class: "smart-basket__product-item"}), o = t("<div>").attr({class: "smart-basket__product-id"}), l = t("<input>").attr({class: "smart-basket__input", type: "hidden"}), c = t("<div>").attr({class: "smart-basket__product-name"}), p = t("<input>").attr({class: "smart-basket__input", type: "hidden"}), d = t("<input>").attr({class: "smart-basket__input", type: "hidden"}), u = t("<input>").attr({class: "smart-basket__input", type: "hidden"}), m = t("<div>").attr({class: "smart-basket__product-quantity"}), k = t("<input>").attr({class: "smart-basket__input", type: "hidden"}), b = t("<button>").attr({class: "smart-basket__add-item"}).text("+"), f = t("<button>").attr({class: "smart-basket__remove-item"}).text("-"), v = t("<input>").attr({class: "smart-basket__product-quantity-state", type: "number", min: "1", step: "1", pattern: "^[0-9]"});
      ...
      let _ = t("<div>").attr({class: "smart-basket__product-price"}), h = t("<input>").attr({class: "smart-basket__input", type: "hidden"}), g = t("<div>").attr({class: "smart-basket__product-price-common"}), y = t("<input>").attr({class: "smart-basket__input"}), M = e.deleteProducts(s, i);
      for (let a in s[n]) {
    ...
    let s, r, n, i, o = e.getProducts() || {}, l = t("<div>").attr({class: "smart-basket"}), c = t("." + a.buttonAddToBasket);
    if (localStorage.getItem(a.localStorageName), l.append(e.showProducts(o)), a.productQuantityWrapper) {
      ...
      let o = t("<button>").attr({class: "smart-basket__add-item"}).html("+"), l = t("<button>").attr({class: "smart-basket__remove-item"}).html("-");
      s = t("<input>").attr({class: "smart-basket__product-quantity-state", min: "1", step: "1", pattern: "^[0-9]", value: "1"}), e.append(l).append(s).append(o), o.click(function (e) {
    ...
    if (a.productSize && a.productPrice) {
      ...
      t("." + a.productElement).find("." + a.productSize + ":first-child").addClass(a.productSize + "_active"), e.click(function (e) {
        ...
        let s = t(this).parents("." + a.productElement).find("." + a.buttonAddToBasket), r = t(this).parents("." + a.productElement).find("." + a.productPrice), n = t(this).attr("data-sb-curent-size");
        console.log(n);
    ...
    let n = 0, i = 0, o = t("<div>").attr({class: "smart-basket__empty-title"}).text("Корзина пуста. Вы не добавили ни одного товара").fadeOut(), l = t("<div>").attr({class: "smart-basket__success-title"}).text("Заказ принят. Ожидайте звонка").css("display", "none"), c = t("<div>").attr({class: "smart-basket__result-common"}), p = t("<div>").attr({class: "smart-basket__price-common"}), d = t("<div>").attr({class: "smart-basket__quantity-common"});
    ...
    let o = t("<img>").attr({class: "smart-basket__min-icon", src: a.smartBasketMinIconPath, width: 18, alt: "Корзина"}), l = t("<span>").attr({class: "smart-basket__min-count"});
    ...
    let s = t("<div>").attr({class: "smart-basket__user-form"}), r = t("<div>").attr({class: "smart-basket__user-info"}), n = t("<div>").attr({class: "smart-basket__input-wrapper"}), i = t("<input>").attr({class: "smart-basket__user-input", type: "text", placeholder: "Введите имя", name: "userName", required: true});
    n.append(i);
    let o = t("<div>").attr({class: "smart-basket__input-wrapper"}), l = t("<input>").attr({class: "smart-basket__user-input", type: "tel", placeholder: "Введите телефон", name: "userTel", required: a.telIsRequired}).mask(a.countryCode + "(000)000-00-00");
    o.append(l);
    let c = t("<div>").attr({class: "smart-basket__input-wrapper"}), p = t("<input>").attr({class: "smart-basket__user-input", type: "email", placeholder: "Введите e-mail", name: "userEmail", required: a.emailIsRequired});
    if (c.append(p), a.agreement.isRequired) {
      var d = t("<div>").attr({class: "smart-basket__agreement-wrapper"});
      let e = t("<label>").attr({class: "smart-basket__label-agreement", for: "smart-basket__input-agreement"}), s = t("<input>").attr({type: "checkbox", name: "agreement", class: "smart-basket__input-agreement", id: "smart-basket__input-agreement", checked: a.agreement.isChecked, value: "Я принимаю условия пользовательского соглашения"}), r = null;
    ...
    let m = t("<button>").attr({class: "smart-basket__send-form", form: "smart-basket__form", type: "submit"}).text("Сделать заказ"), k = t("<div>").attr({class: "smart-basket__footer"});
    r.append(n).append(o).append(c), a.agreement.isChecked && r.append(d), k.append(u).append(m), s.append(r).append(k), m.click(function (t) {
      t.preventDefault();
      let s = e.getProducts() || {};
      function r(t) {
        for (let a in t) return false;
        return true;
      }
      if (a.nameIsRequired && a.telIsRequired && a.emailIsRequired) {
        if ("" === l.val() || "" === i.val() || "" === p.val() || r(s)) return "" === l.val() && l.parent().addClass("smart-basket__input-wrapper_error"), "" === i.val() && i.parent().addClass("smart-basket__input-wrapper_error"), "" === p.val() && p.parent().addClass("smart-basket__input-wrapper_error"), false;
        e.sendCart();
      } else if (a.telIsRequired || a.emailIsRequired) {
        if ("" === i.val() || !("" !== l.val() && a.telIsRequired || "" !== p.val() && a.emailIsRequired) || r(s)) return "" === l.val() && a.telIsRequired && l.parent().addClass("smart-basket__input-wrapper_error"), "" === p.val() && a.emailIsRequired && p.parent().addClass("smart-basket__input-wrapper_error"), "" === i.val() && i.parent().addClass("smart-basket__input-wrapper_error"), false;
        e.sendCart();
      }
    });
    let b = a => {
    ...
    t.ajax({url: "/smartbasket/php/smartbasket.php", type: "POST", data: r, processData: false, contentType: false, beforeSend: function () {}, success: function (t) {}, complete: function (s) {
